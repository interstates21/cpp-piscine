...
{
	std::cout << this->_name << ":: loading... Directive one: Protect humanity! Directive two: Obey Alex at all costs. Directive three: Dance!" << std::endl;
}
...
{
	*this = other;
	std::cout << this->_name + "moves to another skin" << std::endl;
}
...
FragTrap::~FragTrap()
{
	std::cout << this->_name << ":: ~~~~~~~ O-KAY! Thanks for giving me a second chance, God. I really appreciate it." << std::endl;
}
